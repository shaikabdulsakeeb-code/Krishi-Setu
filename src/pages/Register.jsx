    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-1)] py-12 px-4 sm:px-6 lg:px-8">
      <div className="ledger-card max-w-md w-full space-y-8 p-8 relative overflow-hidden">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex bg-[var(--bg-card-alt)] p-1 rounded-full border border-[var(--line)]">
            <button
              type="button"
              className={`flex-1 py-2 text-sm font-semibold rounded-full transition-all ${role === 'farmer' ? 'bg-[var(--primary)] text-white shadow-sm' : 'text-[var(--muted)] hover:text-[var(--cream)]'}`}
            ...
            <button
              type="button"
              className={`flex-1 py-2 text-sm font-semibold rounded-full transition-all ${role === 'buyer' ? 'bg-[var(--primary)] text-white shadow-sm' : 'text-[var(--muted)] hover:text-[var(--cream)]'}`}
