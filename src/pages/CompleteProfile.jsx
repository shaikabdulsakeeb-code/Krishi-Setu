      ...
      <div className="ledger-card max-w-2xl mx-auto space-y-8 p-6 sm:p-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h2 className="text-headline-lg mt-1">{isProfileComplete ? 'Edit Your Profile' : 'Complete Your Profile'}</h2>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                ...
                <button
                  ...
                  disabled={locating}
                  className="form-input shrink-0 px-3 py-2 inline-flex items-center justify-center text-sm font-medium hover:bg-white/10 sm:w-auto"
                >
