...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#fff8f0] text-[#1e1b14] flex flex-col font-sans">
      ...
      <main className="flex-grow flex flex-col justify-center items-center px-4 py-16 sm:py-24 text-center">
        <div className="max-w-3xl space-y-8">
          ...
          <div className="pt-8 flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/register" className="btn-primary text-lg px-8 py-3 shadow-md flex items-center justify-center gap-2 group">
              Join the Network
              <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/login" className="bg-white border border-[#c0c9c1] text-[#1e1b14] rounded-lg px-8 py-3 font-medium hover:bg-gray-50 hover:border-[#717972] transition-colors text-lg flex items-center justify-center">
              Sign In
            </Link>
          </div>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-4xl w-full text-left">
          <div className="ledger-card p-6 flex flex-col items-start gap-4">
